...
3. Other output formats that call `auto_defaults_set()` for you.
...
Auto detecting in other output formats can in theory work if the output format sets `auto_defaults_set()`.
