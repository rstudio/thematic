...
Auto theming works best with a **shiny** runtime, but it can also work under certain conditions inside **rmarkdown** and RStudio. For a quick demonstration, we had a **shiny** app styled with a dark background, light foreground, and a Google Font (e.g. Pacifico), **thematic** can automatically mimic those styles in the R plots.
