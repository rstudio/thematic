...
```{r, echo = FALSE}
knitr::include_graphics("man/figures/shiny-darkly.gif")
```
...
For more examples of **thematic** in action, and to gain a better understanding of how it works, see the [understanding article](https://rstudio.github.io/thematic/articles/understanding.html).
