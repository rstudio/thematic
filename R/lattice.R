...
lattice_par <- function(theme) {
  ...
  params <- list(
    ...
    axis.text =         list(col = fg, fontfamily = font$family),
    add.line =          list(col = fg),
    add.text =          list(col = fg, fontfamily = font$family),
    par.xlab.text =     list(col = fg, fontfamily = font$family),
    par.ylab.text =     list(col = fg, fontfamily = font$family),
    par.zlab.text =     list(col = fg, fontfamily = font$family),
    par.main.text =     list(col = fg, fontfamily = font$family),
    par.sub.text =      list(col = fg, fontfamily = font$family),
    box.3d =            list(col = fg),
